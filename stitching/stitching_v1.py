...
def main():
    ...
    img1 = cv.imread('./stitch_1/230208_084015_L2_V1_P06_D0300.png') 
    img2 = cv.imread('./stitch_1/230208_083942_L2_V1_P05_D0260.png')
    ...
    #cv.waitKey()
    cv.imwrite('./results.png',result)
    cv.imwrite('./matching_result.png',img_matching_result)
